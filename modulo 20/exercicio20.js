(function(window, document){
  ...
  */
  ...
  /* 
   exp regex: ^ para dizer que é início de string. uma lista com um caractere alfanumérico ou +/. o repetidor +
   para dizer que tem que ter pelo menos 1 dessa lista, ai vem o @. \. para escapar o ponto,
   ?: para não fazer a captura do grupo e após isso 2 caracteres alfanuméricos sendo opcionais com ? e $ para final de regex 
   */
