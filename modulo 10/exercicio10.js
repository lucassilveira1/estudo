// TEMAS DO MÓDULO: WRAPPER OBJECTS / TYPEOF
...
(function(){
  ...
  */
  ...
  const isOperatorValid = (operator) => {
    ...
    // Verifica o booleano do operador para ver se é true ou false.
  };
  ...
  */
  ...
  const calculator = (operator) => {
    ...
    return function (x, y) {
      ...
      // Se qualquer um dos dois argumentos não for número, a função retornará false - L
  ...
  */
  ...
  showOperationMessage = (operator, number1, number2) => {
  ...
  */
  ...
  // O primeiro parâmetro é a mensagem de operação. Já o segundo é a função de soma, passando os dois operandos.
