(function(){
  ...
  */
  ...
  console.log(newText.replace('brasileiro', 'carioca'));
  ...
  */
  ...
  console.log(newText.replace(/[0-9]/g, '-')); // outro modo: /\d/g para substuir numeros.
  ...
  */
  ...
  console.log(newText.replace(/[D-Hd-h]/g, 0))
  ...
  */
  ...
  console.log(newText.replace(/[Aa]/g, 4))
