(function() {
  ...
  */
  ...
  // var fullName = 'lucas-silveira';
  // console.log(fullName.charAt(0).toUpperCase() + fullName.slice(1, 5) + ' ' + fullName.charAt(6).toUpperCase() + fullName.slice(7));
  // fullName.charAt(6).toUpperCase();
  ...
  */
  ...
  for( var i = 0, len = myName.length; i < len; i++) {
    intercalado.push( i % 2 === 0 ? myName[i].toUpperCase() : myName[i].toLowerCase());
  }
  console.log(intercalado.join(''));
  
  const email = /^[a-z0-9.]+@[a-z0-9]+\.[a-z]+(\.[a-z]+)?$/i;
  console.log('lucassad13@gmail.com', email.test('lucassad13@gmail.com'));
})();