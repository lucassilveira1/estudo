// TEMAS DO MÓDULO: HOISTING / IMMEDIATELY-INVOKED FUNCTION EXPRESSION (IIFE)
...
(function() {
  ...
  */
  ...
  const calculator = (x, y) => {
    return function qualquer(callback) {
      return callback(x, y);
    };
  };
  ...
  */
  ...
  const subtraction = calculator(25, 5)
  const multiplication = calculator(10, 5)
  const division = calculator(20, 5)
